        ...
        <Grid container spacing={5}>
          <Grid item xs={12} md={4}>
            <Box sx={item}>
              ...
              <Typography variant="h5" style={{color:'white'}}>
                {
                  'From the latest Job Update to Connecting with employees'
                }
                {
          ...
          <Grid item xs={12} md={4}>
            <Box sx={item}>
              ...
              <Typography variant="h5" style={{color:'white'}}>
                {
                  'Welcome our latest additions to the expert team! '
                }
                {'They bring diverse expertise and valuable insights to enhance your Expectations.'}
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={12} md={4}>
            <Box sx={item}>
              ...
              <Typography variant="h5" style={{color:'white'}}>
                {'Explore our talented freelancers who are ready to contribute their skills and expertise.'}
              </Typography>
            </Box>
          </Grid>
        </Grid>
